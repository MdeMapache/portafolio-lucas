...
export const DEFAULT_PORTFOLIO: PortfolioData = {
  ...
  projects: [
    ...
    },
    {
      ...
      longDescription:
        "App Android en Flutter con Clean Architecture (data / domain / presentation), inyección de dependencias con get_it y backend Firebase: Auth con Google Sign-In, Cloud Firestore y notificaciones locales programadas. Las tareas son \"contratos\" con categoría, fases, fecha límite y dificultad, que otorgan oro y experiencia; hay un Mini Boss al que se le hace daño completando contratos, una racha diaria que se reinicia a medianoche y una tienda de objetos. El proyecto se perdió y sólo sobrevivió el APK: como el build no estaba ofuscado, del binario se recuperaron la estructura, los nombres de clases y métodos, los textos y los assets. El demo en vivo no es una maqueta: es esa misma app reconstruida, compilada a web y corriendo contra Firebase. Se entra como invitado anónimo, así que cada visitante recibe su propia taberna vacía.",
    ...
    },
    {
      id: "ionic-gestion",
      icon: "🕐",
      title: "AttendWorkID — Control de asistencia",
      description: "App de asistencia laboral con login por RUT y reconocimiento facial.",
      longDescription:
        "Aplicación híbrida (Ionic + Angular) para control de asistencia de personal, con backend en Firebase (Cloud Firestore). Incluye inicio de sesión por RUT, verificación por reconocimiento facial, gestión de trabajadores (alta, edición y baja con foto), asignación de turnos sobre un calendario y estadísticas mensuales por empleado (días trabajados, atrasos y ausencias). Fue mi proyecto de título; el código fuente se perdió y sólo sobrevivió el build desplegado. La demo corre sobre ese despliegue, con todos los datos reemplazados por registros ficticios.",
      lastCommit: "proyecto de título",
      done: 24,
      total: 24,
      demoUrl: "https://attendworkid-fd400.web.app",
      repoUrl: null,
      tech: ["Ionic", "Angular", "Firebase", "TypeScript"],
      screenshotAssetIds: [],
      controls: [
        { id: "awid-rut", key: "RUT", action: "11111111-1" },
        { id: "awid-clave", key: "Clave", action: "demo1234" },
        { id: "awid-rol", key: "Rol", action: "Administrador" },
      ],
      cheats: [],
      featured: false,
    },
